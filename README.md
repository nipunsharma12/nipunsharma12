...
Pushed 516 commits into the code cosmos of GitHub

Sprouted 2 issues (There must be an issue here)

Championed 489 pull requests

Contributed to 18 repositories (sharing is caring)

Reviewed 545 pull requests (keeping the code clean and mean)
